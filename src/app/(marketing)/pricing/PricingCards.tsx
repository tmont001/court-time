...
function TierCard({ tier, highlighted }: { tier: StandardTier; highlighted?: boolean }) {
  return (
    ...
    >
      ...
      <Link
        href={tier.ctaHref}
        className="mt-5 block w-full text-center py-3 rounded-xl text-sm font-semibold border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:border-gray-500 dark:hover:border-gray-400 motion-safe:transition-all motion-safe:duration-150"
      >
        {tier.ctaLabel}
      </Link>
    </div>
