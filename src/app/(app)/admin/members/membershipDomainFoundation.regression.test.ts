...
describe("0188 — migration numbering", () => {
  ...
  // Phase 42B (0189), 42C-1 (0190), and 42C-3A (0191) are the legitimate
  // next migrations once 0188 is applied — this guard now checks for
  // anything PAST that authorized boundary, not past 0188 itself.
