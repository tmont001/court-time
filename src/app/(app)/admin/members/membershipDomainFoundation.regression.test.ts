...
describe("0188 — migration numbering", () => {
  ...
  // Phase 42B (0189), 42C-1 (0190), 42C-3A (0191), 43A-1 (0192), and its
  // 0193 hotfix are the legitimate next migrations once 0188 is applied —
  // this guard now checks for anything PAST that authorized boundary, not
  // past 0188 itself.
