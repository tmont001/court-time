...
describe("0190 — migration numbering", () => {
  it("is the next migration after immutable 0189, and no unauthorized 0192+ migration exists yet", () => {
    // Phase 42C-3A (0191) is the legitimate next migration once 0190 is
    // applied — this guard now checks for anything PAST that authorized
    // boundary, not past 0190 itself.
