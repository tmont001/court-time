        ...
        <div className="mt-4 space-y-3 border-t border-gray-100 dark:border-gray-800 pt-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className="border border-gray-200 dark:border-gray-600 rounded-lg px-3 py-1.5 text-base md:text-sm text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-accent focus:border-accent disabled:opacity-50 disabled:cursor-not-allowed w-full max-w-xs"
            />
            {editingDate && (
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className="border border-gray-200 dark:border-gray-600 rounded-lg px-3 py-1.5 text-base md:text-sm text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-accent focus:border-accent w-full max-w-sm"
            />
          </div>
